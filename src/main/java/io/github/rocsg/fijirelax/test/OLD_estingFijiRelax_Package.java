...
public class OLD_estingFijiRelax_Package extends PlugInFrame {
	...
	public OLD_estingFijiRelax_Package() {
		super("");
		IJ.log("Here 1");
	}

	
	public OLD_estingFijiRelax_Package(String title) {
		super(title);
		IJ.log("Here 1");
	}
	...
	public static void main(String[]args) {
		...
		OLD_estingFijiRelax_Package test=new OLD_estingFijiRelax_Package("");
		test.testNii();
	}

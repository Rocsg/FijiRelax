...
public class Compute_maps_Sorgho  extends PlugInFrame{
	...
	public static void main(String[]args) {
		...
		Compute_maps_Sorgho ex=new Compute_maps_Sorgho();
		ex.run("");
	}
	
	public Compute_maps_Sorgho() {
	...
	public void run(String arg) {
		...
		String[]specs=null;
		if(part<=0)specs=new String[] {"BM1","BM2","SSM1","SSM2"};
		if(part==1)specs=new String[] {"BM1"};
		if(part==2)specs=new String[] {"BM2"};
		if(part==3)specs=new String[] {"SSM1"};
		if(part==4)specs=new String[] {"SSM2"};
		for(String sp : specs) {
			...
			for(String tim : strTimepoints) {
				...
				bn.nameObservation="SORGHO_EXP01_"+sp+"_"+(tim.split("_")[2]);
		...
		IJ.log("Batch processing of Sorgho is now finished. End of process");
	}
